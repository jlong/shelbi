...
`ID` is resolved against the project YAML's `workspaces:` block first, then
...
| --- | --- | --- | --- |
| `<ID>` | string | — | Workspace name, resolved against `workspaces:` (then the legacy spawn agent registry) (required). |
