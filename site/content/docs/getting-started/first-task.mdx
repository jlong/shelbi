...
as soon as a card hits todo it picks a free workspace and starts them on
it.
...
Enter to launch. Inside a registered project's `work_dir`, that
project always wins (Shelbi resolves by reverse-lookup against
