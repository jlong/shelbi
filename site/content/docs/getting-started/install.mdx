...
title: Install
order: 1
summary: Hosted install script, build-from-source fallback, and verifying the binary on your PATH.
---

Shelbi ships as a single Rust binary. The hosted install script downloads
the latest release and drops the binary on your `PATH`:
