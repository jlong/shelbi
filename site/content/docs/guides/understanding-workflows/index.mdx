...
statuses an issue moves through and the git side-effects that fire on each
...
| **Feature-branch** (GitHub-flow) | Branch per issue off `main`, PR, merge. The default Shelbi shape. | [Feature-branch →](/docs/guides/understanding-workflows/feature-branch) |
