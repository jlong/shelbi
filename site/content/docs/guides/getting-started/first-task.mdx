...
name, the nav (Chat, Tasks, Activity), your declared workspaces, and any
tasks waiting on review. The right pane is a real tmux pane: the
orchestrator agent by default, or one of the built-in views (Chat /
Tasks / Activity) when you switch.
