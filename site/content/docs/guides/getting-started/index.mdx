...
order: 10
summary: Install Shelbi, confirm its detected setup plan once, run an issue, then scale to a pool of workspaces and hand the loop to the orchestrator.
---

Shelbi is an agent orchestrator for the terminal: a board of issues, a
...
customize the detected values. Then you'll **run your first issue** end to end,
...
YAML that declares the statuses an issue moves through and the git
