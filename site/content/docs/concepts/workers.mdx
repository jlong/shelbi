...
work. See [the events log](/docs/features/events-log).
...
- [Workflows](/docs/concepts/workflows#lifecycle-who-moves-a-task-between-the-default-statuses)
  — what the default workflow's statuses mean, and where workers fit
  in the task lifecycle.
- [The events log](/docs/features/events-log) — the shape of every
