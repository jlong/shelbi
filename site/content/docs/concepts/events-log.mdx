...
- The `worker=` token is retained for backward compatibility — the
  slot it names is a [workspace](/docs/concepts/workspaces).
...
| `worker:review-marker`                             | the hub poller                           | The workspace wrote its review-ready marker; the poller promoted the task to review. |
