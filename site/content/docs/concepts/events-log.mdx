...
| `workspace:ready-marker`                           | the hub poller                           | The workspace wrote its ready marker; the poller promoted the task to review. (Historical aliases `workspace:review-marker` and `worker:review-marker` still parse.) |
