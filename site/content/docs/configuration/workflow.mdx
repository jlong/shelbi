...
# Reference-only statuses: name + category come from statuses.yml.
statuses:
...
[`statuses.yml`](/docs/configuration/statuses) — repeating an inline
...
| Field | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `id` | string | yes | — | Stable id, declared in [`statuses.yml`](/docs/configuration/statuses). Conventionally lowercase kebab-case. |
...
- [Statuses](/docs/configuration/statuses) — the `statuses.yml` catalog
