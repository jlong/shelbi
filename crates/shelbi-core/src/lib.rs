...
pub use model::{
    ...
    validate_project_name, validate_task_id, validate_workflow_name, Agent, AgentRunnerSpec,
    Column, ConfigMode, DialogSignature, GitConfig, HeartbeatConfig, Host, Machine, MachineKind,
    MergeStrategy, OrchestratorSpec, ParamDiagnostic, Project, ProjectShape, PromptInjectionKind,
    PromptInjectionSpec, Session, SessionProject, Status, Task, TaskZenConfig, TmuxAddr,
