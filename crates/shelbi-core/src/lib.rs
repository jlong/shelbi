...
pub use model::{
    ...
    AgentRunnerSpec, Column, ConfigMode, DialogSignature, GitConfig, HeartbeatConfig, Host,
    Machine, MachineKind, MergeStrategy, OrchestratorSpec, ParamDiagnostic, Project, ProjectShape,
