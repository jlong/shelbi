...
pub fn handle_sidebar_key(app: &mut App, code: KeyCode, mods: KeyModifiers) {
    ...
    // to check here.
    if keymap::matches_zen_toggle(code, mods, app.zen_toggle_chord) {
        app.toggle_zen_mode();
        return;
    }
    match code {
